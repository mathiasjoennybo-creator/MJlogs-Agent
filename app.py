...
# 🚨 UDVIKLER-HACK: Login er midlertidigt slået fra
...
.stButton > button {{ 
    background-color: #0F52BA !important; color: white !important; border-radius: 8px !important; 
...
[data-testid="stDataFrame"], [data-testid="stTextInput"] input, [data-testid="stNumberInput"] input, 
